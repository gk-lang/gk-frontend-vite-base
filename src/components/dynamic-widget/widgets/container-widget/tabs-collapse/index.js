import widgetTabsCollapse from './tabs-collapse.vue'
...
/**
 * 组件type属性对应解析的类型，tabs-collapse
 * 组件动态解析从这里开始映射
 */
export function widgetDescription() {
  return [{ label: '可折叠tab容器', value: 'tabs-collapse', hidden: false }]
}

export default widgetTabsCollapse
