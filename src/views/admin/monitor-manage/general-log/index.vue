<!-- 普通类日志查询 -->
<template>
  <div class="general-log auto-container">
    ...
    <el-card shadow="never" class="tabs-bar">
      <el-tabs v-model="tabActiveKey" @tab-click="handleClick">
        <el-tab-pane label="日志明细统计" name="first">日志明细统计</el-tab-pane>
        <el-tab-pane label="日志响应统计" name="second">日志响应统计</el-tab-pane>
      </el-tabs>
    </el-card>
    <DynamicTable
      border
      v-show="tabActiveKey === 'first'"
    ...
    <DynamicTable
      border
      v-show="tabActiveKey === 'second'"
      class="table-container"
      :id="'main-table2'"
      :loading="tableLoading2"
      :columns="tableColumns2"
      v-model="tableData2"
      v-model:page="tablePage2"
